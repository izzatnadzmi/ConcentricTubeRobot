...
class Controller(object):
    ...
    def __init__(self, Kp_x=5, Ki_x=0, Kd_x=0, total_time=1, dt=0.05, 
            model=lambda q,uz:moving_CTR(q,uz), plot=False,
            jac_del_q=1e-1, damped_lsq=0, pertubed_model=None):
...
if __name__ == "__main__":
    ...
    if perturbed:
        ...
        CTR_sim = Controller(Kp_x=Kp_x, model=model, total_time=total_time, dt=dt, jac_del_q=jac_del_q, 
                                plot=True, damped_lsq=damped_lsq)
